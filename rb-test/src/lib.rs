...
//! # Introduction
//!
//! `rb_test` is a small addition over plain `assert_eq!` testing approach,
...
//! # Suggested Workflows
//!
//! I like to use data-driven tests with `rb_test`. I usually define a
